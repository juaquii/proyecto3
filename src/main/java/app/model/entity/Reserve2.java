...
public class Reserve2 {
    ...
    public Reserve2(int codReserve, Date date, Room codRoom, List<Client> clients) {
    ...
    public Reserve2(int codReserve, Date date, Room codRoom) {
        this.codReserve = codReserve;
        this.date = date;
        this.room = codRoom;
    }
